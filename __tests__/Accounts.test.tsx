...
describe('Accounts component', () => {
    ...
    test('deletes an account successfully', async () => {
        ...
        Array.from(expandedSections).forEach((section1, index1) => {
            console.log(`Accordion section ${index1} OUTER:`, section1.innerHTML);
            const tempExpandedSections = document.getElementsByClassName('grid-container w-full min-w-full');
            Array.from(tempExpandedSections).forEach((section2, index2) => {
                console.log(`Accordion section ${index1} ${index2}:`, section2.innerHTML);
            });
        });
