...
const WithholdingsAndMiscW2: React.FC = () => {
    ...
    const handleSaveClick = (editedItem: deductions) => {
        const updatedList = deductionsList.map((item) => (item.dedid === editedItem.dedid ? editedItem : item));
    ...
    const handleDeleteClick = (id: number | undefined) => {
        ...
        setDeductions((prevList) => prevList.filter((item) => item.dedid !== id));
    };
                        ...
                        {deductionsList.map((item) => (
                            <tr key={item.dedid}>
                                ...
                                <td>
                                    ...
                                    <Button type="button" onClick={() => handleDeleteClick(item.dedid)}>
                                        Delete
                                    </Button>
                                </td>
                            </tr>
