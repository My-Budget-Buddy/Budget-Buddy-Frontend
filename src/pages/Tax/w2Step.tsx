...
const WwStep: React.FC = () => {
    ...
    const handleSaveClick = (editedItem: W2State) => {
        const updatedList = W2s.map((item) => (item.w2id === editedItem.w2id ? editedItem : item));
        setW2s(updatedList);
    ...
    const handleDeleteClick = (id: number | undefined) => {
        ...
        setW2s((prevList) => prevList.filter((item) => item.w2id !== id));
    };
                                ...
                                {W2s.map((item) => (
                                    <tr key={item.w2id}>
                                        ...
                                        <td>
                                            ...
                                            <Button type="button" onClick={() => handleDeleteClick(item.w2id)}>
                                                Delete
                                            </Button>
                                        </td>
                                    </tr>
                        ...
                        <Grid row className="margin-x-neg-05 flex-justify-center">
                            <Grid row gap={6}>
                                ...
                                <FormGroup>
                                    ...
                                    />
                                    {errors.w2federalIncomeTaxWithheld && (
                                        <span style={{ color: "red" }}>{errors.w2federalIncomeTaxWithheld}</span>
                                    )}
                                </FormGroup>
                                ...
                                <FormGroup>
                                    ...
                                    />
                                    {errors.w2stateIncomeTaxWithheld && (
                                        <span style={{ color: "red" }}>{errors.w2stateIncomeTaxWithheld}</span>
                                    )}
                                </FormGroup>
                                ...
                                <FormGroup>
                                    ...
                                    />
                                    {errors.w2socialSecurityTaxWithheld && (
                                        <span style={{ color: "red" }}>{errors.w2socialSecurityTaxWithheld}</span>
                                    )}
                                </FormGroup>
                                ...
                                <FormGroup>
                                    ...
                                    />
                                    {errors.w2medicareTaxWithheld && (
                                        <span style={{ color: "red" }}>{errors.w2medicareTaxWithheld}</span>
                                    )}
                                </FormGroup>
                            </Grid>
                            <Button type="button" onClick={() => handleSaveClick(W2info)}>
                                Save
                            </Button>
                        </Grid>
                    </GridContainer>
