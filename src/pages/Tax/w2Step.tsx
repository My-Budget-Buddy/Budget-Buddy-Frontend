...
const WwStep: React.FC = () => {
   ...
   useEffect(() => {
    ...
    const handleAddClick = () => {
        ...
        setW2s(prevList => [...prevList, { ...newItem, w2id: newId, w2employer: "", w2federalIncomeTaxWithheld: 0, w2imageKey: undefined, w2medicareTaxWithheld: 0, w2socialSecurityTaxWithheld: 0, w2state: "", w2stateIncomeTaxWithheld: 0, w2taxReturnId: 1, w2userId: 1, w2wages: 0, w2year: 2024 }]);
        setLastId(newId);
        setNewItem({ ...newItem, w2id: newId, w2employer: "", w2federalIncomeTaxWithheld: 0, w2imageKey: undefined, w2medicareTaxWithheld: 0, w2socialSecurityTaxWithheld: 0, w2state: "", w2stateIncomeTaxWithheld: 0, w2taxReturnId: 1, w2userId: 1, w2wages: 0, w2year: 2024 });
    };
