...
describe('SummaryComponent', () => {
    ...
    //     expect(screen.getByText('budgets.spending-budget')).toBeInTheDocument();
    ...
    //     fireEvent.mouseEnter(screen.getByText('budgets.total-funds').nextSibling as HTMLElement);
    //     expect(screen.getByText('This is the total money you have across your checking and savings accounts, minus any debts and money reserved from your Savings Buckets.')).toBeInTheDocument();
    //     fireEvent.mouseLeave(screen.getByText('budgets.total-funds').nextSibling as HTMLElement);
    //     expect(screen.queryByText('This is the total money you have across your checking and savings accounts, minus any debts and money reserved from your Savings Buckets.')).not.toBeInTheDocument();
    // });
});